 ...
 <div class="container">
            ...
            <div class="row tit" style="margin-top: 15px;">
                ...
                <div class="col-md-6 imco" style="margin-top: 15px;">
                    ...
                    <br>
                    <H5>
                        <img class="conta" src="<c:url value="/resources/imagen/telefono.png" />" > 428-108-52-07
                    </H5>
                    <H5>
                        <img class="conta" src="<c:url value="/resources/imagen/gmail.png"/>" > compas.paleria.5@gmail.com
                    </H5>
                </div>
            </div>
        </div>
